...
type ExploreTabsProps = {
    hashtag: PageType<TrendingHashtag>,
...
const ExploreTabs = ({ hashtag, users, initialTab }: ExploreTabsProps) => {
    ...
    return <>
        ...
        <div>
            {
                tab === TabView.HASHTAGS && <MessageHashtagList initialPage={hashtag} />
            }
            {
